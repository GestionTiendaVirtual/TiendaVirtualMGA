...
<html>
    ...
    <body>
      ...
      <h1>Muro de computadoras</h1>
      <form action="computerWall.php" method="POST">
        <textarea type="text" name="comentario"></textarea>
        <input type="submit" name="enviar" value="Enviar comentario">
      </form>

    <?php
    $query="SELECT * FROM tbcomentario where tipoProducto='computadora'";
